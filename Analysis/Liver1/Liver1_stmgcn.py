...
def train_MSpaGCN(opts):
    ...
    for i in range(1, 2):
        ...
        sc.pl.spatial(features_adata, color=["pred"], title="stmgcn",
                      na_in_legend=False, show=True)
...
def parser_set():
    ...
    parser.add_argument('--n_cluster', default=20, type=int)
